...
(function () {
    ...
    ***************************************************************************** */
    ...
    var WAIT_FOR_WINDOW_DRIVER_RESPONSE_TIMEOUT = 5000;
    ...
    function returnSinglePropMode (options) {
        if (!options)
            return false;
    ...
    var SelectorExecutor = /** @class */ (function (_super) {
        ...
        function SelectorExecutor(command, globalTimeout, startTime, createNotFoundError, createIsInvisibleError) {
            ...
            _this.returnSinglePropMode = returnSinglePropMode(_this.dependencies.filterOptions);
            if (startTime) {
        ...
        SelectorExecutor.prototype._validateElement = function (args, startTime) {
            ...
            return hammerhead.Promise.resolve()
                ...
                var createTimeoutError = !isElementExists ? _this.createNotFoundError : _this.createIsInvisibleError;
        ...
        ActionExecutor.prototype._createAutomation = function () {
            ...
            switch (this.command.type) {
                ...
                case COMMAND_TYPE.setFilesToUpload:
                    return new testcafeAutomation.Upload(this.elements[0], this.command.filePath, function (filePaths) { return new ActionCannotFindFileToUploadError(filePaths); });
